...
class Scheduler(threading.Thread):
    ...
    def add_job(self, new_job): #new_job is in the same format in task_list
        ...
        random_new_pop = genetic.rand_pop(self,tasks, 30)
...
################# initial population
    population = genetic.rand_pop(task_list, 100)
    # print("\tInitial population is ready.\n")

    # for gen in range(200):
    #     population = genetic.evolve(population, task_list)
...
# print(oga_fjs("bran/Mk02.fjs",time_unit_param = 1))
